			...
			soiltemperatureC: {
				approvedFolders:{
					"uplink.decoded": {
						assignfunction: this.commonAssign,
						common: {
							role: this.assignableRoles.value.temperature,
							unit: this.assignableUnits.temperatureC
						}
					}
				},
			},
			soilmoisture: {
				approvedFolders:{
					"uplink.decoded": {
						assignfunction: this.commonAssign,
						common: {
							role: this.assignableRoles.value.main,
							unit: this.assignableUnits.volPercent
						}
					}
				},
			},
			soilconductivity: {
				approvedFolders:{
					"uplink.decoded": {
						...
						common: {
							role: this.assignableRoles.value.main,
							unit: this.assignableUnits.cunductivity
						}
					}
				},
			},
			volt: {
				approvedFolders:{
					"uplink.decoded": {
						assignfunction: this.commonAssign,
						common: {
							role: this.assignableRoles.value.voltage,
							unit: this.assignableUnits.voltage
						}
					}
				},
			}
		};
		this.assign.OPEN = this.assign.open;
