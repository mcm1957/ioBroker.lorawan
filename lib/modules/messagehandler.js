...
class messagehandlerClass {
	...
	async addDirectoriesToPresentDirectory(startDirectory){
		this.directoryhandler.generateRekursivObjects(this.directoryhandler.directories.application.devices.deviceUid.deviceId.downlink.toSend,`${startDirectory}.${this.directoryhandler.directoryStructur.downlinkToSend}`,"","");
