		...
		try{
			for(const downlinkDevices of Object.values(this.adapter.downlinkConfighandler.activeDownlinkConfigs)){
				...
				for(const downlinkConfig of Object.values(downlinkDevices)){
					...
					if((downlinkConfig.deviceType === "all" || changeInfo.deviceType.indexOf(downlinkConfig.deviceType) === 0) && downlinkConfig.deviceType.length > foundLength){
						...
						foundLength = downlinkConfig.deviceType.length;
					}
				}
			}
		}
