		...
		try{
			...
			if(messageType === "up"){
				...
				* ******************************************************************/
				...
				await this.directoryhandler.generateRekursivObjects({time: message.rx_metadata.time},startId,topic,{time: message.rx_metadata.time},{dontAssign:true});
		...
		try{
			...
			if(messageType === "up"){
				...
				* ******************************************************************/
				...
				await this.directoryhandler.generateRekursivObjects({time: message.rxInfo[0].nsTime},startId,topic,{time: message.rxInfo[0].nsTime},{dontAssign:true});
